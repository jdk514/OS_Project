cmd_net/tipc/zone.o := gcc -m32 -Wp,-MD,net/tipc/.zone.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.1/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os -pipe -msoft-float -mpreferred-stack-boundary=2  -march=i686 -mtune=generic -mregparm=3 -ffreestanding -Iinclude/asm-i386/mach-generic -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(zone)"  -D"KBUILD_MODNAME=KBUILD_STR(tipc)" -c -o net/tipc/.tmp_zone.o net/tipc/zone.c

deps_net/tipc/zone.o := \
  net/tipc/zone.c \
  net/tipc/core.h \
...
net/tipc/zone.o: $(deps_net/tipc/zone.o)
