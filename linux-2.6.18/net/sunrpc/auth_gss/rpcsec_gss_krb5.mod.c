...
__attribute__((section("__versions"))) = {
	...
	{ 0xb56717cf, "xtime" },
	{ 0x87961803, "krb5_encrypt" },
	{ 0x1b7d4074, "printk" },
	{ 0x5152e605, "memcmp" },
	{ 0x4e187030, "crypto_free_tfm" },
	{ 0xa1d91e33, "gss_encrypt_xdr_buf" },
...
MODULE_INFO(srcversion, "8FBB31CD9B4F7FE5A35BF8C");
