...
__attribute__((section("__versions"))) = {
	...
	{ 0x56179c5f, "mtrr_add" },
	{ 0x9c012508, "fb_parse_edid" },
	{ 0xeae3dfd6, "__const_udelay" },
	{ 0x75b57c1b, "pci_release_regions" },
	{ 0xf4c29e1f, "cfb_fillrect" },
	{ 0x5600904f, "fb_get_color_depth" },
...
"depends=i2c-core,cfbfillrect,cfbimgblt,i2c-algo-bit,cfbcopyarea";

MODULE_ALIAS("pci:v000010DEd*sv*sd*bc03sc*i*");

MODULE_INFO(srcversion, "14A62B5C80B5D389B602BB6");
